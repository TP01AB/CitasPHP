            ...
            ?>
                <div class="card m-3 col-3 " style="border: 2px solid antiquewhite">
                    ...
                    <div class="card-footer">
                        <button type="submit" name="hacerAmigo" class=" text-dark btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="Me gusta">
                        ...
                        <button type="submit" name="enviarMensaje" class=" text-dark btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="Enviar mensaje">
        ...
        <div class="row">
            ...
            ?>
                <div class="card m-3 col-3 " style="border: 2px solid antiquewhite">
                    ...
                    <div class="card-footer">
                        <button type="submit" name="eliminar amigo" class=" text-dark btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="No me gusta">
