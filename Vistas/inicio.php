...
<body class="" onload="validacionLogin()">
    ...
    $usuarios = unserialize($_SESSION['todos']);
    ?>
                    ...
                    <div class="card-body">
                        <form class="text-center needs-validation" action="../Controlador/controladorUsuario.php" method="POST">
                            <div class="px-4">
                                ...
                                <div class="bg-<?php if ($usuario->get_puntuacion() < 150) {
                                                    echo 'warning';
                                                } else if ($usuario->get_puntuacion() > 150) {
                                                    echo 'success';
                                                } ?> rounded"><?= $usuario->get_puntuacion() ?></div>
                            </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" name="hacerAmigo" class="  text-success btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="Me gusta">
                        ...
                        <button type="submit" name="eliminaramigo" class=" text-danger btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="No me gusta">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                            </svg>
                        </button>
                        <button type="submit" name="enviarMensaje" class=" text-primary btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="Enviar mensaje">
