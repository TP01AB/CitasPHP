    ...
    <nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark mb-3">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <?php if (isset($_SESSION['usuarioActual'])) {
                $rol = $_SESSION['rolActual'];
                $online = $_SESSION['allOnline'];
            ?>
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php if ($rol == 1) { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="../Vistas/inicioAdmin.php">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="../Vistas/preferencias.php">Prefencias</a>
                        </div>
                    </li>
                </ul>
                ...
                -->
                <ul class="navbar-nav ">
                    <form action="../Controlador/controlador.php" class="form-inline my-2 my-lg-0 " method="POST">
                        <li class="nav-item">
                            <button class="btn btn-link " type="submit" name="search" id="search">
                        ...
                        <li class="nav-item">
                            <button class="btn btn-link " type="submit" name="close" id="close">
            ...
            <?php
                ...
                <ul class="navbar-nav ">
                    <form action="../Controlador/controlador.php" class="form-inline my-2 my-lg-0 " method="POST>
                        <li class=" nav-item">
                        <button class="btn btn-link " type="submit" name="vistaLogin">
                            Login
                        </button>
                        </li>
                        <li class="nav-item">
                            <button class="btn btn-link " type="submit" name="vistaRegistro">
                                Registro
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="btn btn-link " type="submit" name="vistaOlvidada">
                                Contraseña olvidada
                            </button>
                        </li>
                    </form>
